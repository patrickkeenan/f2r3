...
- Use prototyping transiton field instead of linkTo=nodeId
- Lighting makes layers washed out
- Add animation to interaction changes
- XR
  - Set camera and pixel size to match
- Performance
  - Only generate layer images for the current root layer children
  - Better error handling: no file access
